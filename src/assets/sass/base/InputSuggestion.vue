<!--
  ...
  const InputSuggestion  = () => import('@/components/base/InputSuggestion')
...
export default {
    ...
    if (this.value) {
      if (this.returnObject) {
        ...
        if (typeof this.value === 'object') {
          ...
          this.searchVal = getName[this.displaySelected] ? getName[this.displaySelected] : ''
        }
      }
    }
  },
  ...
  methods: {
    ...
    clearValue () {
      this.searchVal = ''
      // this.$emit('input', { q: this.searchVal, type: 'clear' })
      this.$emit('input', '')
      this.showList = false
    },
